...
import { type TextFieldType, type DefaultValues } from "@hubspot/cms-components/fields";
type EcommProductListingFieldsType = DefaultValues<{
    categoryCode?: TextFieldType;
}>;
export default EcommProductListingFieldsType;