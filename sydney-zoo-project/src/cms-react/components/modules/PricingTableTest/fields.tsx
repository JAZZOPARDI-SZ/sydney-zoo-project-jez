...
import { ModuleFields, RichTextField, RepeatedFieldGroup, TextField, ChoiceField, ImageField, NumberField, LinkField, ColorField, DateField } from "@hubspot/cms-components/fields";
	...
	<ModuleFields>
		...
		>
			<ChoiceField
				...
				label="Product Theme"
				default={'grey'}
				choices={[ [ "orange", "Orange" ], [ "sky", "Sky" ], [ "grey", "Grey" ] ]}
				display="select"
			/>
			<TextField
				name="tagLine"
		...
		>
			...
			>
				...
				<ChoiceField
					...
					label="Product Theme"
					default={'grey'}
					choices={[ [ "orange", "Orange" ], [ "sky", "Sky" ], [ "grey", "Grey" ], [ "white", "White" ] ]}
					display="select"
				/>
			</RepeatedFieldGroup>
		</RepeatedFieldGroup>
